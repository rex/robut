// ClaudeTokenBundle.swift — Robut's full-scope Claude token, as a value.
//
// The bundle is pure data; every decision about WHEN to read, refresh, or
// write it belongs to ClaudeTokenManager (the single-flight actor). See
// ADR-0001 — the v0.14 layer died precisely because this separation
// didn't exist and concurrent fetches raced the refresh.
